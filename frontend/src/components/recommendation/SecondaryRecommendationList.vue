  ...
  <section>
    ...
    <div class="mt-5 space-y-5">
      <button
        ...
        :key="card.card_id"
        type="button"
        class="grid w-full cursor-pointer grid-cols-[88px_1fr_auto] items-center gap-4 rounded-lg border border-[#ebe5e0] bg-white p-4 text-left shadow-[0_8px_24px_rgba(0,18,120,0.04)] transition hover:-translate-y-0.5 hover:border-[#001278]/30 focus:outline-none focus:ring-4 focus:ring-[#001278]/10"
